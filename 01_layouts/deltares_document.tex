...
\newcommand{\addLastPage}{1} %0=no; 1=yes
\newcommand{\addBibliography}{1} %0=no; 1=yes
...
%\input{../00_references/project_info} %common data in proposals
...
%\def\myVersion{\projectnumber{}-001\_v1.\svnInfoRevision} %using common data in proposals
...
\begin{document}
\memoTo{Aukje Spruyt, Johan Boon} %optional argument [no] to disable "To" for letters. 
...
%\vspace{2.5cm}
%Johan Boon \\
%Head of department Rivers and Inland Shipping
%
%\FloatBarrier
%\newpage
...
%---------GENERAL
%\FloatBarrier
%\gensection{\isreport}{1}{This and that}
%\label{app:tad}

%---------CV
%\FloatBarrier
%\gensection{\isreport}{1}{Curricula Vit\ae}
%\label{app:CV}

%\includepdf[pages=-,offset=2.54cm -2.54cm,angle=0]{../11_CV/CV_VC.pdf}
%\includepdf[pages=-,offset=2.54cm -2.54cm,angle=0]{../11_CV/CV_AB.pdf}
%\includepdf[pages=-,offset=2.54cm -2.54cm,angle=0]{../11_CV/CV_BvM.pdf}
%\includepdf[pages=-,offset=2.54cm -2.54cm,angle=0]{../11_CV/CV_BS.pdf}

%---------TERMS AND CONDITIONS
%\FloatBarrier
%\gensection{\isreport}{1}{Terms and Conditions}
%\label{app:conditions}
%
%\includepdf[pages=-,offset=2.54cm -2.54cm,angle=0]{../12_conditions/conditions.pdf}
