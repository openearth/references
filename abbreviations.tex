...
\newcommand{\slidecite}[1]{\makebox[\linewidth][r]{\tiny #1}}
...
%fm notation 
\newcommand{\xiL}        {\vec{\xi}_{L_j}}
\newcommand{\xiLm}       {\vec{\xi}_{L_{j-1}}}
\newcommand{\xiR}        {\vec{\xi}_{R_j}}
...
\newcommand{\dfastbe}{D-FAST BE}
\newcommand{\dfastbelong}{D-FAST Bank Erosion}
...
\newcommand{\smt}{SMT}
\newcommand{\smtlong}{Simulation Managment Tool}
...
\newcommand{\simtugrid}{\texttt{sim2ugrid}}
\newcommand{\grideditor}{\textsc{GridEditor}}
\newcommand{\interacter}{\textsc{Interacter}}
\newcommand{\rgfgrid}{\textsc{RGFGRID}}
\newcommand{\ShorelineS}{ShorelineS}
\newcommand{\SnapWave}{SnapWave}

%institutes
\newcommand{\RWS}{\textit{Rijkswaterstaat}}
\hyphenation{Rijks-wa-ter-staat}
...
%\newenvironment{myvarfont}{\fontfamily{<qag>}\selectfont}{\par}
%\newcommand{\keyword}[1]{{\myvarfont{#1}}}
...
\newcommand{\RME}{Rhine-Meuse estuary}
...
%models 
\newcommand{\DVR}{DVR}
\newcommand{\DVRlong}{Duurzame vaardiepte Rijndelta}
\newcommand{\DVRlongEN}{Sustainable Fairway Rhine Delta}

\newcommand{\IRM}{IRM}
\newcommand{\IRMlong}{Integraal RivierManagement}
\newcommand{\IRMlongEN}{Integrated River Management}

\newcommand{\RVDRt}{RvdR 2.0}
\newcommand{\RVDRtlong}{Ruimte voor de Rivier 2.0}
\newcommand{\RVDRtlongEN}{Room for the River 2.0}
