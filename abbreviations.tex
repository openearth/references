...
\newcommand{\Pmap}{Pmap}
\newcommand{\telemac}{\textsc{Telemac-Mascarte-Sisyphe}}
...
\newcommand{\refDHL}{Delft Hydraulics Laboratory, Delft, the Netherlands}
\newcommand{\refRHDHV}{HaskoningDHV Nederland B.V., Maastricht, the Netherlands}
\newcommand{\refFugro}{Fugro Ingenieursbureau B.V., Arnhem, the Netherlands}
\newcommand{\refUU}{Utrecth University, Utrecht, the Netherlands.}
